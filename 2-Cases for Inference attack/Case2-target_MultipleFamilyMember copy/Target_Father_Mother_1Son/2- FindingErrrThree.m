...
foundprob = xlsread('Father Mother One Son Probabilities.xlsx');%% the results from applying FindProbFM.m
%%For independent assumption, we use "Father and Mother One Son Probabilities (Independent Assumption).xlsx"
