...
FLeakedInfo = xlsread('FM5SLeakedInfo.xlsx');
save('FLeakedInfo.mat','FLeakedInfo');%convert the file
familySum = xlsread('Father Mother Five Sons Sum Partial.xlsx'); %% the query noisy results file which contains the partial info the adversary could know.
    ...
    for i = 1: 100
        ...
        elseif familySum(i,k) == 10
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(11, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 11
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(12, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 12
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(13, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 13
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(14, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 14
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(15, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 15
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(16, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 16
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(17, 2)- data(unknown(i,1),unknown(i,2)) ;
                else7
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
            ...
            if isnan(familySum(i,k+1))
                Comparesnp = FLeakedInfo(18, 2)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
    ...
    for i = 1: 100
        ...
        elseif familySum(i,k) == 10
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(11, 3)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 11
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(12, 3)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 12
            if isnan(familySum(i,k+1))
                ...
                Comparesnp = FLeakedInfo(13, 3)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
        ...
        elseif familySum(i,k) == 16
            ...
            if isnan(familySum(i,k+1))
                Comparesnp = FLeakedInfo(18, 3)- data(unknown(i,1),unknown(i,2)) ;
            else
                if familySum(i,k+1)== 0
                    x=0;
                elseif familySum(i,k+1)== 10
