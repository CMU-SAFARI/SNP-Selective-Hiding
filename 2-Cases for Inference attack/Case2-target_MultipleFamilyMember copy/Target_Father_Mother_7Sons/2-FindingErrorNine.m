...
foundprob = xlsread('Father Mother Seven Sons Probabilities.xlsx');%% the results from applying FindProbFM.m
%%For independent assumption, we use "Father Mother seven Sons Probabilities(Independent Assumption).xlsx"
save('foundprob.mat','foundprob');%convert the file 
familySum = xlsread('Father and Mother and seven Sons Sum.xlsx Sum.xlsx');%% the query noisy results file.
