...
foundprob = xlsread('Son Probabilities.xlsx'); %% the results from applying FindProbS.m
%%For independent assumption, we use "Son Only Probabilities (Independent Assumption).xlsx"
save('foundprob.mat','foundprob');%convert the file
familySum = xlsread('Son Only Sum.xlsx'); %% the query noisy results file.
