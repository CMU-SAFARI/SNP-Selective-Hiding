...
FLeakedInfo = xlsread('SLeakedInfo.xlsx'); %the leaked SNPs values according to the probabilities of genotypes sum.
save('FLeakedInfo.mat','FLeakedInfo');%convert the file
familySum = xlsread('Son Only Sum.xlsx'); %% the query noisy results file which contains the partial info the adversary could know.
