...
foundprob = xlsread('Father Probabilities.xlsx'); %% the results from applying FindProbS.m
%%For independent assumption, we use "Father Only Probabilities (Independent Assumption).xlsx"
